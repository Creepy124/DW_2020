...
public class ExtractFileToStaging {
	...
	public ExtractFileToStaging(Configuration configuration, FileService fileService, DBService dbService, LogService logService) {
	...
	public static void main(String[] args) throws SQLException {
		...
		ExtractFileToStaging test = new ExtractFileToStaging(config, fileService, dbService, logService);
